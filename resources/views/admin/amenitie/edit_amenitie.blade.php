                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="myForm" class="forms-sample" method="POST" action="{{ route('update.amenitie') }}">
                            @csrf
                            <input type="hidden" name="id" id="id" value="{{$amenitie->id}}">
                            <div class="form-group mb-3">
                                <label for="amenities_name" class="form-label">Amenities Name</label>
                                <input type="text" name="amenities_name" class="form-control" id="amenities_name" autocomplete="off" value="{{$amenitie->amenities_name}}">
                            </div>
